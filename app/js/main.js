...
/* harmony import */ var _components_seo_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/seo.js */ "./src/js/components/seo.js");
...
window.initializeDropdown = function (element) {
  const dropdown = new bootstrap_js_dist_dropdown_js__WEBPACK_IMPORTED_MODULE_0__(element);
...
window.initializeOffcanvas = function (element) {
  const offcanvas = new bootstrap_js_dist_offcanvas_js__WEBPACK_IMPORTED_MODULE_0__(element);
...
document.querySelectorAll('.stages-swiper')?.forEach(element => {
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](swiperElement, {
    slidesPerView: 3,
    spaceBetween: 24,
    navigation: {
      nextEl: swiperNext,
